...
class MainsController < ApplicationController
	...
	def create
		...
		url = "http://www.amazon.com/s/ref=nb_sb_noss_1?url=search-alias%3Daps&field-keywords=#{item}"
			dump = Array.new
			price = Array.new
			image = Array.new
